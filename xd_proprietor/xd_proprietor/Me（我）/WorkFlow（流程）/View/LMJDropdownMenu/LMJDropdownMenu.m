...
- (void)initPropertys{
    ...
    _titleTextFont           = [UIFont systemFontOfSize:20];
...
- (void)setTitleTextFont:(UIFont *)titleTextFont{
    ...
    self.mainBtn.titleLabel.font = titleTextFont;
}
...
- (void)showDropDown{   // 显示下拉列表
    ...
    [UIView animateWithDuration:self.animateTime animations:^{
        ...
        weakSelf.optionsList.frame = CGRectMake(0, self->_originHeight, self.frame.size.width, 127);
